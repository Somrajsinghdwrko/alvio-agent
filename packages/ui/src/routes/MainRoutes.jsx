...
// demos routing
const PlanCardDemo = Loadable(lazy(() => import('@/views/demos/PlanCardDemo')))

// billing routing
const BillingPage = Loadable(lazy(() => import('@/views/billing/BillingPage')))
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/demos/plan-cards',
            element: <PlanCardDemo />
        },
        {
            path: '/billing',
            element: <BillingPage />
